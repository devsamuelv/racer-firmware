...
/**
 * @brief structure for handling 16 channels of data, 11 bits each. Which
 * channel is used depends on transmitter setting
 *
 ...
 *
 * @param latitude int32 the latitude of the GPS in degree / 10,000,000 big
 * endian
 * @param longitude int32 the longitude of the GPS in degree / 10,000,000 big
 * endian
...
typedef enum { CRSF_DEST_FC = 0xC8, CRSF_DEST_RADIO = 0xEA } crsf_dest_t;
 ...
 *
 * @param dest destination (to send back to transmitter destination is
 * CRSF_DEST_FC)
